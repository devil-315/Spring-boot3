...
import com.devil.web.biz.UserBizHandler;
...
public class WebFunctionConfig {
     ...
     */
    @Bean
    public RouterFunction<ServerResponse> useRoute(UserBizHandler userBizHandler/*这个会被自动注入进来*/){
        return RouterFunctions.route()//开始定义路由信息
                ...
                .PUT("/user/1",RequestPredicates.accept(MediaType.APPLICATION_JSON),userBizHandler::updateUser)
